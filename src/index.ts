// import { SvelteApplication } from '@typhonjs-fvtt/runtime/svelte/application';  // DISABLED - UI not needed
// import { TJSPosition } from '@typhonjs-fvtt/runtime/svelte/store/position';  // DISABLED - UI not needed
import { writable } from 'svelte/store';
import { setupSettings } from './settings.ts';
import { loadAnimations } from './storage/index.ts';
// import { registerTours } from './tours';  // DISABLED - UI not compatible with v13 yet

import { i18n } from './utils.ts';
// import { setupSidebar } from './view/AnimationSidebar/index.ts';  // DISABLED - UI not compatible with v13 yet
import './app.postcss';
import './assets/index.ts';
import './view/index.ts';

// V13 TJS SHIM - DISABLED since UI components are disabled
...
Hooks.once('setup', () => {
	setupSettings();
	// setupSidebar(); // DISABLED - UI not compatible with v13 yet
});
...
Hooks.once('ready', () => {
	...
	initSockets();
	loadAnimations();
	// registerTours(); // DISABLED - UI not compatible with v13 yet
});
